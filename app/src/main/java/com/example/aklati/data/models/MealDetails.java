...
public class MealDetails implements Serializable {
    ...
    public String[] getIngredients() {
        ...
        for (int i = 0; i < 20; i++) {
            String ingredient = getIngredient(i + 1);
            ingredients[i] = cleanString(ingredient);
        }
        return ingredients;
    }
    ...
    public String[] getMeasures() {
        ...
        for (int i = 0; i < 20; i++) {
            String measure = getMeasure(i + 1);
            measures[i] = cleanString(measure);
        }
        return measures;
    }

    // Helper method to clean strings (removes null, empty, and whitespace-only strings)
